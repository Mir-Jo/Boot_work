...
import org.example.SpringBootDeveloper.config.TokenAuthenticationFilter;
import org.example.SpringBootDeveloper.config.oauth.OAuth2SuccessHandler;
import org.example.SpringBootDeveloper.repository.OAuth2AuthorizationRequestBasedOnCookieRepository;
import org.example.SpringBootDeveloper.repository.RefreshTokenRepository;
import org.example.SpringBootDeveloper.service.OAuth2UserCustomService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        return http
                ...
                //4. Authorization 요청과 관련된 상태 저장
                    .authorizationEndpoint(authorizatonEndpoint ->
                        authorizatonEndpoint.authorizationRequestRepository(
